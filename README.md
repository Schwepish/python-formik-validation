...
The Formik library provides us a hook to give initial values to the form and
...
Lets look at the age schema as an example. We want to accept a `number()` which
